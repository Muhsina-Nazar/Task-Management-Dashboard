      ...
      <div className="rounded-xl border border-border bg-card/60 p-5 shadow-sm">
        <div className="flex items-center justify-between mb-2">
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground mt-0.5">Tasks Completion Velocity</span>
          </div>
        ...
        <div className="w-full bg-secondary h-2.5 rounded-full overflow-hidden border border-border/50">
          <div
            ...
            className="h-full bg-gradient-to-r from-primary to-blue-500 rounded-full transition-all duration-500 ease-out shadow-sm"
          ></div>
        </div>
      </div>
